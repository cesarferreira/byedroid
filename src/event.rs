...
fn map_normal(code: KeyCode, modifiers: KeyModifiers) -> Option<AppEvent> {
    let action = match code {
        ...
        KeyCode::Char('r') | KeyCode::Char('R') => Some(Action::RunApp),
        ...
        KeyCode::Char('u') | KeyCode::Char('U') => Some(Action::UninstallApp),
        KeyCode::Char('C') => Some(Action::ClearAppData),
        KeyCode::Char('T') => Some(Action::ClearAppCache),
